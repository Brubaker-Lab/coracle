coracle_verbosity <- "coracle_verbosity"
mode_quiet <- "quiet"
mode_verbose <- "verbose"
mode_debug <- "debug"

set_coracle_verbosity <- function(level){

  rlang::arg_match(level, c(mode_quiet, mode_verbose, mode_debug))

  options(coracle_verbosity = level)

}

is_verbose <- function(){

  (getOption(coracle_verbosity, default = mode_verbose) == mode_verbose) || is_mode_debug()
}

is_quiet <- function(){
  getOption(coracle_verbosity, default = mode_verbose) == mode_quiet
}

is_debug <- function(){
  getOption(coracle_verbosity, default = mode_verbose) == mode_debug
}
